...
*/
function bilgisayar(){
  let r_bilgisayar =Math.ceil(Math.random()*3);
  let p_tercih = "";
  if (r_bilgisayar===1){
    p_tercih = "Taş";
  }else if (r_bilgisayar===2){
    p_tercih = "Kağıt";
  }else p_tercih = "Makas";
  return p_tercih;
}
...
return cmdeger/30.48;
}
console.log(feetDonusturucu(55166));
...
harf_n ="D aldın";}
else if (alınan_not<60){
harf_n ="F aldın";}
return harf_n
}

console.log(notHesapla(51))
